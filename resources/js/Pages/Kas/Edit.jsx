...
export default function Edit({ auth, kas }) {
    ...
    useEffect(() => {
        if (kas.tanggal) {
            const formattedDate = format(new Date(kas.tanggal), "yyyy/MM/dd");
            setDisplayedDate(format(new Date(kas.tanggal), "d MMMM yyyy", { locale: id }));
    ...
    const handleChange = (field, value) => {
        if (field === "tanggal") {
            ...
            setDisplayedDate(format(date, 'd MMMM yyyy', { locale: id }));
        }
        setData((prevData) => ({
            ...prevData,
            [field]: value,
    ...
    return (
        ...
        >
            ...
            <div className="py-6 my-6 px-10 bg-slate-200 bg-opacity-70 rounded-lg">
                <form onSubmit={editKas} className="space-y-6">
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <RupiahInput
                                value={data.biaya}
                                onChange={(value) => handleChange("biaya", value)}
                                placeholder="biaya"
                                error={errors.biaya}
                            />
                            <div className="flex items-center space-x-4 pt-3">
